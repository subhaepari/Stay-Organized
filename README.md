...
A task could be assigned to a user on creation and could also be re-assigned to any other user.
A task could belong to any pre-defined category - 
...
A task could be in a complete or incomplete state.
